...
import { IconSearch, IconPin, IconChevronLeft, IconChevronRight, IconAlertTriangle } from '../../components/icons';
    ...
    <PubLayout title="Kho Từ Đã Duyệt">
      ...
      <div className="flex gap-3 mb-6">
        <div className="relative flex-1">
          ...
          <input className="w-full bg-gray-800 border border-gray-700 rounded-lg pl-10 pr-4 py-2.5 text-white placeholder-gray-500 focus:outline-none focus:border-indigo-500"
