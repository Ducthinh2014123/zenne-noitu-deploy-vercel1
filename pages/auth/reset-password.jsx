              ...
              <div>
                ...
                {recoveryToken ? (
                  <>
                    <div className="mb-4">
                      <Alert type="success">
                        Xác minh thành công! Recovery Token đã được tạo.
                      </Alert>
                    </div>

                    <label className="block text-xs font-semibold text-gray-400 mb-1.5 uppercase tracking-wider">
                      Recovery Token của bạn (chỉ hiện một lần)
                    </label>
                  ...
                  <p className="text-sm text-gray-400 mb-4">
                    Dán Recovery Token mà Admin đã gửi cho bạn khi script yêu cầu.
                  </p>
                )}


                <p className="text-sm text-gray-300 mb-2">
                  Mở <b>Developer Console</b> của trình duyệt (phím F12) trên trang này, dán đoạn script bên dưới và nhấn Enter:
                </p>
                ...
                <Alert type="info">
                  Script sẽ hỏi Recovery Token, gửi lên server để xác minh, rồi trang sẽ tự tải lại. Trang không tự tạo cookie đăng nhập — server là bên duy nhất tạo phiên khôi phục.
                </Alert>
