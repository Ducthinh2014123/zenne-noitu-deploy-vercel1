...
import { IconLink, IconLock, IconLogIn, IconRocket, IconSparkles, IconCheckCircle, IconInfo, IconAlertTriangle, IconShieldCheck, IconChevronRight, IconCheck } from '../../components/icons';
      ...
      <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4"
        ...
        <div className="w-full max-w-sm">
          <div className="text-center mb-7">
            <div className="flex justify-center mb-3 text-indigo-400"><IconShieldCheck className="w-12 h-12" /></div>
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6">
            ...
            <form onSubmit={do2FA} className="space-y-4">
              ...
              <button type="submit" disabled={any || totpCode.length!==6}
                ...
                {loading==='totp'?<><div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin"/>Xác nhận...</>:<><IconCheckCircle className="w-4.5 h-4.5" /> Xác nhận</>}
              </button>
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4"
        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-7">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl mb-3 bg-indigo-600/15 border border-indigo-500/25 shadow-lg text-indigo-400"><IconLink className="w-8 h-8" /></div>
            ...
            <div className="p-6">
              ...
              {msg.text && (
                <div className={`flex gap-2 items-start p-3.5 rounded-xl text-sm mb-5 border ${
                  ...
                  <span className="flex-shrink-0 mt-0.5">{msg.type==='success'?<IconCheckCircle className="w-4 h-4" />:msg.type==='info'?<IconInfo className="w-4 h-4" />:<IconAlertTriangle className="w-4 h-4" />}</span>
                  <span>{msg.text}</span>
                </div>
              )}
                ...
                <>
                  ...
                  <form onSubmit={doLogin} className="space-y-4" noValidate>
                    ...
                    <button type="submit" disabled={any}
                      ...
                      {loading==='creds'?<><div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin"/>Đang đăng nhập...</>:<><IconRocket className="w-4.5 h-4.5" /> Đăng nhập</>}
                    </button>
                  </form>
                  ...
                  <form onSubmit={doRegister} className="space-y-4" noValidate>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        {rPw2&&rPw2===rPw&&<div className="absolute right-3 top-1/2 -translate-y-1/2 text-green-400"><IconCheckCircle className="w-4 h-4" /></div>}
                      </div>
                    ...
                    <button type="submit" disabled={any}
                      ...
                      {loading==='reg'?<><div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin"/>Đang tạo...</>:<><IconSparkles className="w-4.5 h-4.5" /> Tạo tài khoản</>}
                    </button>
                  </form>
                ...
                {showAdmin && (
                  <form onSubmit={doAdminLogin} className="mt-3 space-y-3">
                    ...
                    <button type="submit" disabled={aLoading}
                      ...
                      {aLoading?<><div className="w-3.5 h-3.5 border-2 border-white/30 border-t-white rounded-full animate-spin"/>Đang kết nối...</>:<><IconLogIn className="w-4 h-4" /> Vào Admin Dashboard</>}
                    </button>
                  </form>
                )}
              </div>
